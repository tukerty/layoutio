<template>
  <div id="currentimage" :class="{cursorHidden: showZoom}" @mousewheel="handleScroll">
    ...
    <canvas id="left-main" width="640" height="400" style="border:1px solid #BBB" @mouseup="mouseUp" @mousemove="mouseMove" @mousedown="mouseDown" @contextmenu="preventContext">
    </canvas>
    <canvas id="left-zoom" :width="magSize" :height="magSize" v-bind:class="{hidden: !showZoom}"></canvas>
    <img id="left-img" src="../assets/LowerArm.png" alt="">
...
export default {
  ...
  mounted(){
    this.mainc = document.getElementById("left-main")
    this.mainctx = this.mainc.getContext("2d")
    this.zoomc = document.getElementById("left-zoom")
    this.zoomctx = this.zoomc.getContext("2d")
    this.image = document.getElementById("left-img")
    this.image.onload = () => {
